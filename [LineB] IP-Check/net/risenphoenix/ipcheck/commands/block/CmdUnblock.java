...
/*    */ 
/*    */ 
/*    */ public class CmdUnblock
/*    */   extends Command
/*    */ {
/*    */   private BlockManager cBlockManager;
/*    */   private ConfigurationManager CM;
/*    */   
/*    */   public CmdUnblock(Plugin plugin, String[] callArgs, CommandType type)
/*    */   {
...
/*    */     
/* 53 */     setName(getLocalString("CMD_UNBLOCK"));
/* 54 */     setHelp(getLocalString("HELP_UNBLOCK"));
/* 55 */     setSyntax("ipc unblock <COUNTRY_ID | help>");
/* 56 */     setPermissions(new Permission[] { new Permission("ipcheck.use"), new Permission("ipcheck.unblock") });
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/*    */       }
/*    */       
/* 78 */       boolean result = this.cBlockManager.unblockCountry(args[1]);
/*    */       
/* 80 */       String msg = result ? getLocalString("UNBLOCK_SUC") : getLocalString("UNBLOCK_ERR");
/*    */       
/*    */ 
/* 83 */       String addon = "";
/* 84 */       if (result)
...
/* Location:              D:\[ Plugins ] Minecraft - Editar\IP-Check.jar!\net\risenphoenix\ipcheck\commands\block\CmdUnblock.class
